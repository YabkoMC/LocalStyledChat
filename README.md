...
### This is fork of [StyledChat](https://github.com/Patbox/StyledChat) with local (range-limited) chat channel. Not an addon!
...
## Configuration:
You can find config file in `./config/local-styled-chat.json`.
